...
# Typy ogloszen do pobrania. "ContractNotice" = ogloszenie o zamowieniu (potwierdzone).
# Dla wynikow probujemy kilku nazw - niedzialajace zostana pominiete.
NOTICE_TYPES = ["ContractNotice", "ContractAwardNotice", "ContractCompletionNotice"]
...
def pobierz_ogloszenia():
    ...
    for nt in NOTICE_TYPES:
        ...
        while True:
            ...
            # jednorazowy podglad struktury pierwszego rekordu
            if pozycje and not pokazano:
                print("\n=== STRUKTURA pierwszego ogloszenia (nazwy pol) ===")
                print(json.dumps(pozycje[0], ensure_ascii=False, indent=2)[:2500])
